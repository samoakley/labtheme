...
if ( ! bp_is_user() ) { ?><div id="buddypress"><?php } ?>
...
<?php if ( bp_docs_has_docs() ) : ?>
	...
	<div id="bp-docs-pagination">
		<div id="bp-docs-pagination-count">
			<?php printf( __( 'Viewing %1$s-%2$s of %3$s assignments', 'bp-docs' ), bp_docs_get_current_docs_start(), bp_docs_get_current_docs_end(), bp_docs_get_total_docs_num() ) ?>
		</div>
...
<?php if ( ! bp_is_user() ) { ?></div><!-- /#buddypress --><?php } ?>

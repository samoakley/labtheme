						...
						<table class="toggle-table" id="toggle-table-tags">
							<tr>
								<td class="desc-column">
									<label for="bp_docs_tag"><?php _e( 'Tags are words or phrases that help to describe and organize your Assignments.', 'bp-docs' ) ?></label>
				...
				<div class="toggleable <?php bp_docs_toggleable_open_or_closed_class() ?>">
					...
					<div class="toggle-content">
						<table class="toggle-table" id="toggle-table-parent">
							<tr>
								<td class="desc-column">
									<label for="parent_id"><?php _e( 'Select a parent for this Assignment.', 'bp-docs' ) ?></label>

									<span class="description"><?php _e( '(Optional) Assigning a parent Assignment means that a link to the parent will appear at the bottom of this Assignment, and a link to this Assignment will appear at the bottom of the parent.', 'bp-docs' ) ?></span>
								</td>
